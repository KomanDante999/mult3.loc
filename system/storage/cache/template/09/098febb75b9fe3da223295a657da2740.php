...
class __TwigTemplate_f26ee8e9ea672a5a2db651ffb90926d3 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t<script src=\"catalog/view/theme/multishop/assets/{{ script }}\" type=\"text/javascript\"></script>
\t\t{% endfor %}
\t\t<!-- Google Web Fonts -->
\t\t<link rel=\"preconnect\" href=\"https://fonts.gstatic.com\">
\t\t<link
...
\t\t\t\t{{ menu }}
\t\t\t\t<div
\t\t\t\t\tclass=\"col-lg-3 d-none d-lg-block\">{# <a class=\"btn d-flex align-items-center justify-content-between bg-primary w-100\" data-toggle=\"collapse\" href=\"#navbar-vertical\" style=\"height: 65px; padding: 0 30px;\">
